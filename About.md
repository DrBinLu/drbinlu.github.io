...
<div style="flex: 1; min-width: 200px;">
    <div style="display: flex; gap: 0px; justify-content: center;">
        <img src="/images/Hiking.jpg" alt="Bushwalking by the beach" style="height: 120px; position: relative; z-index: 2; margin-right: -20px; border-radius: 12px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3);">
